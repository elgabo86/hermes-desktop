...
export const fr = defineLocale({
  ...
  fileMenu: {
    ...
    deleteBody: 'Déplacé dans la Corbeille — restaur able depuis celle-ci.',
  ...
  boot: {
    ...
    failure: {
      ...
      remoteSignInHint: (signInLabel: string) => `Ouvre la fenêtre de connexion ${signInLabel}. Utilisez la passerelle locale pour basculer vers le backend intégré.`,
      ...
      remoteFailureHint: 'Vérifiez l\'URL de la passerelle et connectez-vous dans les paramètres de passerelle, ou basculez vers la passerelle locale.'
    }
  },
  ...
  notifications: {
    ...
    installMethodUnsupportedTitle: "Cette méthode d'installation n'est pas supportée",
  ...
  titlebar: {
    ...
    layoutEditorTitle: 'Éditeur de disposition des panneaux'
  },
  ...
  keybinds: {
    ...
    actions: {
      ...
      'view.toggleReview': 'Basculer le panneau de revue',
      ...
      'composer.history': 'Parcourir la fenêtre contextuelle / historique',
  ...
  settings: {
    ...
    plugins: {
      ...
      blurb:
        'Extensions d\'interface chargées dans cette application — incluses dans la version ou déposées dans le dossier desktop-plugins (y compris celles écrites par Hermes). Désactiver décharge une extension immédiatement et survit aux redémarrages.',
      count: n => `${n} installée${n === 1 ? '' : 's'}`,
      ...
      disable: 'Désactiver',
      failed: 'échec',
      empty: 'Aucune extension de bureau installée.',
      kinds: { bundled: 'intégrée', disk: 'sur disque', runtime: 'exécution' }
    },
    notifications: {
      title: 'Notifications',
      intro:
    ...
    appearance: {
      ...
      uiScaleDesc: (percent: number) =>
        `Redimensionne le texte et les contrôles dans toute l\'application. Ctrl avec +, - et 0 fonctionne aussi. Actuel : ${percent}%.`,
      ...
      pet: {
        title: 'Mascotte',
        intro:
          'Adoptez une mascotte animée qui flotte sur l\'application et réagit à ce que fait Hermes — court pendant l\'exécution, célèbre les succès, boude les erreurs.',
        restartHint:
          'Les mascottes nécessitent un redémarrage — l\'application en cours a démarré avant cette fonctionnalité. Quittez et rouvrez Hermes, puis revenez ici.',
        on: 'Activé',
        off: 'Désactivé',
        scaleTitle: 'Taille',
        scaleDesc: 'Redimensionnez la mascotte. S\'applique partout instantanément.',
        roamTitle: 'Déambuler',
        roamDesc: 'Laissez la mascotte se promener dans la fenêtre quand elle est inactive.',
        chooseTitle: 'Choisir une mascotte',
        chooseDesc: 'En choisir une l\'installe (si besoin) et l\'active.',
        searchPlaceholder: 'Rechercher…',
        unreachable: 'Impossible d\'atteindre la galerie. Vérifiez votre connexion et rouvrez cette page.',
        noMatch: query => `Aucune mascotte ne correspond à « ${query} ».`,
        installedTag: 'installée',
        generatedTag: 'Générée',
        countCapped: (cap, total) => `${cap} sur ${total} affichées — tapez pour filtrer.`,
        count: n => `${n} mascotte${n === 1 ? '' : 's'}.`,
        uninstall: name => `Désinstaller ${name}`,
        delete: name => `Supprimer ${name}`,
        deleteTitle: name => `Supprimer ${name} ?`,
        deleteBody: 'Cela supprime définitivement la mascotte — impossible de la réinstaller.',
        ...
        turnOnFailed: 'Échec de l\'activation',
        turnOffFailed: 'Échec de la désactivation'
      }
    },
    fieldLabels: defineFieldCopy({
      ...
      stt: {
        ...
        echoTranscripts: 'Afficher les transcriptions',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      stt: {
        ...
        echoTranscripts: 'Afficher la transcription brute 🎙️ des messages vocaux dans le chat.',
    ...
    config: {
      ...
      keepAwakeDesc:
        'Empêcher cette machine de se mettre en veille pendant les longues exécutions. L\u2019écran peut encore s\u2019assombrir.'
    },
    credentials: {
    ...
    gateway: {
      ...
      remoteAuthHint: 'Les passerelles hébergées utilisent OAuth ou un mot de passe ; les passerelles auto-hébergées peuvent utiliser un jeton de session.',
      ...
      defaultConnection: 'Connexion par défaut pour chaque profil sans son propre remplacement.',
    ...
    mcp: {
      ...
      saveServer: 'Enregistrer le serveur',
        ...
        enableServer: (name: string) => `Activer ${name}`,
        disableServer: (name: string) => `Désactiver ${name}`,
        serverEnabled: (name: string) => `${name} activé — s'applique aux nouvelles sessions.`,
        serverDisabled: (name: string) => `${name} désactivé — s'applique aux nouvelles sessions.`,
        ...
        catalogNeedsInstall: 'Compilation requise',
        catalogInstall: 'Installer',
        catalogInstalling: 'Installation...',
        catalogInstallStarted: (name: string) => `Installation de ${name}... s'applique aux nouvelles sessions une fois terminé.`,
        catalogInstallFailed: (name: string) => `Échec de l\'installation de ${name}`,
        catalogEnvPrompt: (name: string) => `${name} nécessite des identifiants`,
        catalogEnvRequired: 'Remplissez les valeurs requises avant l\'installation.',
        ...
        authenticatedMessage: (server: string, count: number) => `${server} : ${count} outils`,
        waitingForBrowser: 'En attente du navigateur…',
        authenticate: 'Authentifier',
        unsavedConnect: 'Non enregistré — enregistrez mcp.json pour vous connecter.',
        enableTool: (tool: string) => `Activer ${tool}`,
        disableTool: (tool: string) => `Désactiver ${tool}`,
    ...
    model: {
      ...
      staleAuxWarning: (count, names, provider) => `${count} tâche${count === 1 ? '' : 's'} auxiliaire${count === 1 ? '' : 's'} (${names}) utilise${count === 1 ? '' : 'nt'} ${provider}, pas votre modèle principal.`,
    ...
    providers: {
      ...
      localEndpoint: {
        ...
        description: 'Adresse du serveur de passerelle local'
      },
  ...
  skills: {
    ...
    failedToUpdate: (name: string) => `Échec de la mise à jour de ${name}`,
    tabMcp: 'MCP',
    ...
    bulkUpdated: (count: number) => `${count} ${count === 1 ? 'élément mis à jour' : 'éléments mis à jour'} pour les nouvelles sessions.`,
    bulkNoChange: 'Rien à changer.',
    usageCount: (count: number | string) => `utilisé ${count}×`,
    provenance: {
      agent: 'Appris',
      bundled: 'Intégré',
      hub: 'Hub'
    },
    emptyNoneFound: (noun: string) => `Aucun ${noun} trouvé`,
    emptyNothingMatches: (query: string) => `Rien ne correspond à « ${query} ».`,
    emptyNoneAvailable: (noun: string) => `Aucun ${noun} disponible pour l\'instant.`,
    changesApplyNewSessions: 'Les changements s\'appliquent aux nouvelles sessions.',
    ...
    hub: {
      ...
      resultCount: (count: number, ms: number | null) => `${count} résultat${count === 1 ? '' : 's'}${ms !== null ? ` en ${ms}ms` : ''}`,
      timedOut: (sources: string) => `Délai dépassé : ${sources}`,
      installed: 'Installé',
      install: 'Installer',
      installing: 'Installation...',
      ...
      close: 'Fermer',
      files: 'Fichiers',
      noReadme: 'Ce skill n\'a pas de SKILL.md à prévisualiser.',
      trust: {
        builtin: 'intégré',
      ...
      policyAsk: 'Vérifier avant l\'installation',
      policyBlock: 'Installation bloquée par la politique',
      findings: (count: number) => `${count} résultat${count === 1 ? '' : 's'}`,
      noFindings: 'Aucun problème de sécurité.',
      installStarted: (name: string) => `Installation de ${name}...`,
      uninstallStarted: (name: string) => `Désinstallation de ${name}...`,
  ...
  starmap: {
    ...
    close: 'Fermer le graphe mémoire',
    refresh: 'Actualiser',
    memory: 'Mémoire',
    filterAll: 'Tout',
    ...
    viewGraph: 'Graphe',
    loadFailed: 'Impossible de charger le graphe mémoire',
    loading: 'Chargement…',
    emptyTitle: 'Rien d\'appris pour l\'instant',
    emptyDesc: 'Quand Hermes crée des compétences et des souvenirs pour votre travail, ils apparaissent ici.',
    share: 'Partager la carte',
    shareHint: 'Copiez le code pour partager cette carte, ou collez-en un pour la charger. Seule la disposition est incluse, pas vos souvenirs ou compétences.',
    ...
    importSuccess: nodes => `Carte chargée avec ${nodes} nœud${nodes === 1 ? '' : 's'}.`,
  ...
  commandCenter: {
    ...
    pets: {
      ...
      error: 'Impossible d\'atteindre la galerie.',
    ...
    generatePet: {
      ...
      promptHint: 'Tapez une description, puis Entrée pour générer quatre versions.',
      readyHint: 'Appuyez sur Entrée pour générer quatre versions.',
      generate: 'Générer',
      ...
      hatchRow: (_state, done, total) => `Image ${done} sur ${total}…`,
      ...
      backgroundHint: 'Vous pouvez fermer — Hermes vous notifiera.',
      slowProviderHint: 'Cela peut prendre plusieurs minutes',
      remix: 'Remixer',
      remixConfirmTitle: 'Remixer cette version ?',
      remixConfirmBody: 'Génère un nouvel ensemble à partir de celle-ci. Peut prendre plusieurs minutes.',
      genericError: 'Échec de la génération — réessayez.',
      referenceImageTooLarge: 'Image de référence trop volumineuse. Utilisez-en une de moins de 16 Mo.',
      referenceImageInvalid: 'Impossible de lire cette image. Essayez PNG, JPG, WebP ou GIF.',
      adopt: 'Adopter',
    ...
    sectionDescriptions: {
      maintenance: 'Diagnostics, sauvegardes, gestionnaire des skills et données de mémoire',
    ...
    logLevel: 'Niveau',
    logSearchPlaceholder: 'Filtrer les lignes de log...',
    maintenance: {
      runOps: 'Diagnostics',
      doctor: 'Lancer doctor',
      doctorDesc: 'Vérifier l\'installation, la config et les providers',
      securityAudit: 'Audit de sécurité',
      securityAuditDesc: 'Scanner la config et les skills pour des paramètres risqués',
      backup: 'Créer une sauvegarde',
      backupDesc: 'Zipper config, mémoires, skills et sessions',
      debugShare: 'Partage de débogage',
      debugShareDesc: 'Envoyer un rapport expurgé + logs, obtenir des liens partageables (auto-supprimés en 6h)',
      debugShareRunning: 'Envoi du rapport de débogage...',
      debugShareLinks: 'Liens de partage',
      debugShareFailed: 'Échec du partage de débogage',
      copyLink: 'Copier le lien',
      linkCopied: 'Lien copié',
      curator: 'Gestionnaire de skills',
      curatorDesc: 'Revue en arrière-plan qui archive les skills obsolètes créés par l\'agent',
      curatorPaused: 'En pause',
      curatorActive: 'Actif',
      curatorDisabled: 'Désactivé',
      curatorLastRun: (when: string) => `Dernière exécution ${when}`,
      curatorNeverRan: 'Jamais exécuté',
      pause: 'Pause',
      resume: 'Reprendre',
      runNow: 'Exécuter maintenant',
      memoryData: 'Données de mémoire',
      memoryDataDesc: 'Fichiers de mémoire intégrés injectés à chaque session',
      memoryProvider: (name: string) => `Provider actif : ${name}`,
      ...
      resetConfirm: (target: string) => `Supprimer ${target} ? Action irréversible.`,
      resetDone: (files: string) => `${files} supprimés.`,
      resetFailed: 'Échec de la réinitialisation de la mémoire',
      actionStarted: (name: string) => `${name} démarré — suivi du log...`,
      actionFailed: (name: string) => `Échec du démarrage de ${name}`,
      running: 'En cours...',
      viewLog: 'Journal d\'actions'
    }
  },
  ...
  sidebar: {
    ...
    projects: {
      ...
      ideaShuffle: 'Alterner les modèles',
      ...
      copyPath: 'Copier le chemin',
      removeFromSidebar: 'Masquer de la barre',
      createFailed: 'Impossible de créer le projet',
      staleBackend:
        'Mettez à jour le backend Hermes pour créer des projets — votre backend est plus ancien que cette app (Paramètres → Mises à jour → Backend).',
      deleteConfirm: 'Cela supprime le projet de Hermes. Fichiers, dépôts git et worktrees restent intacts.',
      ...
      convertBranchDesc: 'Ouvrez des branches checked-out, ou créez un worktree pour une branche libre.',
      ...
      removeWorktreeFailed: 'Impossible de supprimer le worktree (modifications non commitées ?)',
      removeWorktreeConfirm: 'Le supprimer de git (supprime le dossier worktree ; la branche reste), ou simplement masquer le lane et garder le worktree sur disque.',
      removeWorktreeDirty: 'Ce worktree a des modifications non commitées. Forcer la suppression (abandonne ces modifications), ou masquer le lane et le garder.',
      ...
      branchOff: () => ({ before: 'brancher depuis ', after: '' }),
    ...
    row: {
      ...
      export: 'Exporter',
      rename: 'Renommer',
      branchFrom: 'Brancher depuis ici',
      archive: 'Archiver',
      ...
      openInSplit: 'Ouvrir en partage',
      finishedUnread: 'Terminé — non lu',
  ...
  composer: {
    ...
    placeholderStarting: 'Lancement de Hermes...',
    ...
    stopSpeakingReplies: 'Arrêter la lecture à voix haute',
  ...
  statusStack: {
    coding: {
      title: 'Code',
      noBranch: 'Pas de branche',
      detached: 'Détaché',
      clean: 'Propre',
      changed: (count: number) => `${count} fichier${count === 1 ? '' : 's'} modifié${count === 1 ? '' : 's'}`,
      ahead: (count: number) => `${count} commit${count === 1 ? '' : 's'} en avance`,
      behind: (count: number) => `${count} commit${count === 1 ? '' : 's'} en retard`,
      review: 'Relecture',
      close: 'Fermer',
      ...
      revertConfirm: 'Abandonner les modifications de ce fichier ? Cette action est irréversible.',
      revertAllConfirm: 'Abandonner toutes les modifications ? Cette action est irréversible.',
      staged: 'Indexé',
      ...
      generateCommitMessage: 'Générer le message',
      ...
      agentShipPrompt: 'Examine les modifications, commite avec un message conventional-commit, push la branche et ouvre une pull request.',
      newBranch: 'Nouvelle branche',
      branchOffFrom: base => `Nouvelle branche depuis ${base}`,
      switchTo: branch => `Basculer sur ${branch}`,
      switchFailed: branch => `Impossible de basculer sur ${branch}`,
  ...
  onboarding: {
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'auto-hébergé',
        description: 'Pointez Hermes vers un point d\'accès local ou auto-hébergé compatible OpenAI (vLLM, llama.cpp, Ollama, etc.).'
      },
      fireworks: {
        short: 'API modèle directe',
    ...
    localApiKeyPlaceholder: 'Clé API (optionnelle — uniquement si votre point d\'accès en nécessite une)',
    couldNotSave: 'Impossible d\'enregistrer le secret.',
    connecting: 'Connexion',
    update: 'Mettre à jour',
    flowSubtitles: {
    ...
    fireworksPitch: 'API directe — modèles hébergés par Fireworks',
  ...
  shell: {
    ...
    approvalMode: {
      ...
      smart: 'Intelligent',
      smartDescription: 'Évaluer automatiquement et demander si nécessaire',
      off: 'Désactivé',
      offDescription: 'Exécuter sans demander d\'approbation'
    },
    statusbar: {
      unknown: 'inconnu',
      restart: 'redémarrer',
      ...
      modelPinned: 'épinglé par vous ; les nouveaux chats utilisent ce modèle au lieu du paramètre par défaut',
      ...
      contextUsagePanel: {
        ...
        empty: 'Aucune donnée de contexte',
        loading: 'Chargement…',
        percentFull: percent => `${percent}% plein`,
        title: 'Utilisation du contexte',
        tokenSummary: (used, max) => `${used} / ${max} tokens`
      },
      openContextUsage: 'Ouvrir le détail du contexte',
      session: 'Session',
  ...
  preview: {
    ...
    linkHint: 'Cliquez pour ouvrir',
    diff: 'Diff',
    diskChangedTitle: 'Fichier modifié sur le disque',
    diskChangedBody: 'Le fichier a été modifié en dehors d\'Hermes.',
    overwrite: 'Écraser',
    discardReload: 'Recharger',
    saveFailed: message => `Échec de la sauvegarde : ${message}`,
    edit: 'Modifier',
  ...
  assistant: {
    thread: {
      ...
      resumeWhenBackgroundDone: (count: number) => `${count} tâche${count === 1 ? '' : 's'} en arrière-plan — reprise une fois terminée${count === 1 ? '' : 's'}`,
      thinking: 'Réflexion',
    ...
    tool: {
      ...
      actions: {
        ...
        opened: 'Ouvert',
        opening: 'Ouverture',
        failedToOpen: 'Échec d\'ouverture',
        searched: 'Recherché',
        searching: 'Recherche',
        ran: 'Exécuté',
        running: 'Exécution',
      ...
      titles: {
        browser_click: { done: 'Élément cliqué', pending: 'Clic sur élément', pendingAction: 'Clic' },
        browser_fill: { done: 'Champ rempli', pending: 'Remplissage', pendingAction: 'Remplissage' },
        browser_navigate: { done: 'Page ouverte', pending: 'Ouverture de page', pendingAction: 'Ouverture' },
        browser_snapshot: { done: 'Capture d\'écran', pending: 'Capture en cours', pendingAction: 'Capture' },
        browser_take_screenshot: { done: 'Capture prise', pending: 'Capture en cours', pendingAction: 'Capture' },
        ...
        cronjob: { done: 'Tâche planifiée', pending: 'Planification', pendingAction: 'Planification' },
        edit_file: { done: 'Fichier modifié', pending: 'Modification', pendingAction: 'Modification' },
        ...
        session_search_recall: { done: 'Historique consulté', pending: 'Consultation', pendingAction: 'Consultation' },
        terminal: { done: 'Commande exécutée', pending: 'Exécution', pendingAction: 'Exécution' },
        todo: { done: 'Tâches mises à jour', pending: 'Mise à jour', pendingAction: 'Mise à jour' },
        vision_analyze: { done: 'Image analysée', pending: 'Analyse', pendingAction: 'Analyse' },
        web_extract: { done: 'Page lue', pending: 'Lecture', pendingAction: 'Lecture' },
        web_search: { done: 'Recherche web', pending: 'Recherche web', pendingAction: 'Recherche' },
        write_file: { done: 'Fichier écrit', pending: 'Écriture', pendingAction: 'Écriture' }
      },
      statusDone: 'Terminé'
    }
  },
  ...
  desktop: {
    ...
    branchTitle: n => `Brouillon : Branche #${n}`,
  ...
  zones: {
    ...
    dirLeft: 'gauche',
    dirRight: 'droite',
    pluginDisabled: pluginId => `Extension « ${pluginId} » désactivée`,
    pluginDisabledBody: 'Réactivez-la dans Paramètres → Extensions pour restaurer le panneau.',
    missingPane: paneId => `panneau manquant : ${paneId}`,
    editTitle: 'Dispositions',
    editHint: 'Choisissez une disposition, ou faites glisser les panneaux entre les zones. Clic droit sur une zone pour diviser.',
    reset: 'Réinitialiser',
    templates: 'Modèles',
    custom: 'Personnalisé',
    ...
    zoneEditorTitle: 'Éditeur de zone',
    editorHintPre: 'clic pour diviser · ',
    editorHintPost: ' inverse la ligne · glisser entre les zones pour fusionner · glisser les bords partagés pour redimensionner',
