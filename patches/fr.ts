...
export const fr: Translations = {
  ...
  boot: {
    ...
    failure: {
      ...
      remoteSignInHint: signInLabel =>
        `Déconnecte la session navigateur distante enregistrée, puis ouvre ${signInLabel}. Utilisez la passerelle locale pour basculer vers le backend intégré.`,
      signOutAndSignIn: 'Se déconnecter et se reconnecter',
      remoteFailureHint: 'Vérifiez l\'URL et la connexion dans les paramètres de la passerelle, ou passez à la passerelle locale.',
  ...
  notifications: {
    ...
    installMethodUnsupportedTitle: 'Méthode d\'installation non supportée',
  ...
  titlebar: {
    ...
    layoutEditorTitle: 'Éditeur de disposition — ⌘-clic réinitialise la disposition'
  },
  ...
  settings: {
    ...
    plugins: {
      ...
      blurb:
        'Extensions d\'interface chargées dans cette app — incluses dans la version, ou déposées dans le dossier desktop-plugins (y compris celles écrites par Hermes). Désactiver décharge un plugin en direct et persiste après les redémarrages.',
      ...
      disable: 'Désactiver',
      failed: 'échec',
      empty: 'Aucun plugin de bureau installé pour l\'instant.',
      kinds: { bundled: 'intégré', disk: 'sur disque', runtime: 'exécution' }
    },
    sections: {
      model: 'Modèle',
      chat: 'Chat',
    ...
    config: {
      ...
      keepAwakeDesc: 'Empêche cette machine de se mettre en veille pour que les longues exécutions nocturnes continuent. L\'écran peut toujours s\'éteindre.'
    },
    credentials: {
    ...
    gateway: {
      ...
      remoteAuthHint: 'Les passerelles hébergées utilisent OAuth ou un nom d\'utilisateur/mot de passe ; les passerelles auto-hébergées peuvent utiliser un jeton de session.',
      cloudTitle: 'Hermes Cloud',
      cloudDesc: 'Connectez-vous une fois à Hermes Cloud et choisissez parmi les agents de votre compte — sans URL à saisir.',
      ...
      sshDesc:
        'Hermes est lancé sur la machine distante via SSH et tunnellisé vers cette app — rien à démarrer ni à exposer vous-même. Nécessite un accès SSH par clé fonctionnel vers l\'hôte.',
      sshTrustHint: 'La première clé d\'hôte présentée est approuvée et épinglée ; les changements ultérieurs sont bloqués.',
      sshHostTitle: 'Hôte',
      ...
      sshHostCustom: 'Personnalisé (saisir manuellement)…',
      ...
      sshHermesPathDesc: 'Chemin complet du binaire hermes distant. Vide = auto-détection.',
      sshHermesPathPlaceholder: 'auto-détection',
      ...
      sshErrHostKey:
        'La clé d\'hôte a CHANGÉ depuis votre dernière connexion. Vérifiez que cela est attendu, puis exécutez ssh-keygen -R <hôte> et reconnectez.',
      sshErrNotInstalled:
      ...
      sshErrPlatform:
        'Plateforme distante non supportée. Le mode SSH de Hermes Desktop supporte les hôtes Linux, macOS et Windows.',
      sshErrTimeout: 'Délai de connexion SSH dépassé. L\'hôte est peut-être injoignable ou en veille.',
    ...
    mcp: {
      ...
      toggleFailed: name => `Échec du basculement de ${name}`,
      tabServers: 'Serveurs',
      ...
      catalogNeedsInstall: 'Installation requise',
      catalogInstall: 'Installer',
      catalogInstalling: 'Installation…',
      catalogInstallStarted: name => `Installation de ${name}… s'applique aux nouvelles sessions une fois terminé.`,
      ...
      unsavedConnect: 'Non enregistré — enregistrez mcp.json pour connecter.',
    ...
    model: {
      ...
      notInCatalog: 'ne figure pas dans la liste des modèles de ce fournisseur — les appels peuvent basculer vers un modèle de secours.',
      tasks: {
    ...
    providers: {
      ...
      localEndpoint: {
        title: 'Endpoint local / personnalisé',
        description: 'Pointez Hermes vers n\'importe quel endpoint compatible OpenAI (Zyphra, vLLM, llama.cpp, Ollama, etc.).'
      },
    ...
    toolsets: {
      ...
      postSetupInstalledHint: 'Installé. Relancez l\'installation uniquement en cas de problème.',
  ...
  skills: {
    ...
    visionModelHint:
      'La vision utilise votre configuration de modèles auxiliaires — le modèle capable d\'images est choisi là-bas, pas par fournisseur ici.',
    ...
    sortAlpha: 'A–Z',
    sortMostUsedDesc: '↓ Les plus utilisés',
    sortLeastUsedAsc: '↑ Les moins utilisés',
    ...
    emptyNoneAvailable: noun => `Aucun ${noun} disponible pour l'instant.`,
    ...
    hub: {
      ...
      policyAsk: 'À vérifier avant d\'installer',
      policyBlock: 'Installation bloquée',
      findings: count => `${count} résultat${count === 1 ? '' : 's'}`,
      noFindings: 'Aucun problème de sécurité détecté.',
      ...
      actionFailed: 'Échec de l\'action sur le skill',
  ...
  commandCenter: {
    ...
    sectionDescriptions: {
      maintenance: 'Diagnostics, sauvegardes, curateur et données mémoire',
    ...
    maintenance: {
      ...
      securityAuditDesc: 'Analyser la configuration et les skills pour détecter les paramètres à risque',
      backup: 'Créer une sauvegarde',
      backupDesc: 'Compresser la configuration, les mémoires, les skills et les sessions',
      debugShare: 'Partage de debug',
      debugShareDesc: 'Téléverser un rapport expurgé + logs, obtenir des liens partageables (suppression automatique en 6h)',
      debugShareRunning: 'Téléversement du rapport de debug…',
      debugShareLinks: 'Liens de partage',
      debugShareFailed: 'Échec du partage de debug',
      copyLink: 'Copier le lien',
      linkCopied: 'Lien copié',
      curator: 'Curateur de skills',
      curatorDesc: 'Analyse en arrière-plan qui archive les skills obsolètes créés par l\'agent',
      ...
      memoryFile: 'Mémoire agent (MEMORY.md)',
      ...
      resetDone: files => `${files} supprimé${files.includes(' and ') ? 's' : ''}.`,
      resetFailed: 'Échec de la réinitialisation de la mémoire',
      actionStarted: name => `${name} lancé — suivi du journal…`,
      actionFailed: name => `Échec du lancement de ${name}`,
      running: 'En cours…',
  ...
  cron: {
    ...
    modelLabel: 'Modèle',
    modelDefault: 'Défaut (modèle global)',
    ...
    scriptOnlyEditHint: 'Tâche script uniquement (pas de prompt IA). ID :',
    saveChanges: 'Enregistrer les modifications',
  ...
  sidebar: {
    ...
    projects: {
      ...
      branchOff: () => ({ after: '', before: 'brancher depuis ' }),
    ...
    row: {
      ...
      backgroundRunning: 'Tâche d\'arrière-plan en cours',
  ...
  composer: {
    ...
    queueResumeTip: 'Mis en pause par Arrêter — reprenez l\'envoi des tours en file',
  ...
  onboarding: {
    ...
    fireworksPitch: 'API directe de modèles — modèles de pointe hébergés par Fireworks',
  ...
  shell: {
    ...
    approvalMode: {
      ...
      smart: 'Intelligent',
      smartDescription: 'Auto-approuver les commandes sans danger, demander pour le reste',
      off: 'Désactivé',
      offDescription: 'Ne jamais demander — permet toutes les actions'
    },
    statusbar: {
      unknown: 'inconnu',
      restart: 'redémarrer',
      ...
      connectionCloudTooltip: host => `Connecté à l'agent cloud ${host}`,
      connectionSshTooltip: host => `Connecté via SSH à ${host}`,
      connectionRemoteTooltip: host => `Connecté au gateway distant ${host}`,
